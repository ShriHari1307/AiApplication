    ...
    <div className="flex items-center justify-center mb-8">
        <div className="flex items-center justify-between w-55 md:w-50 sm:w-50 h-10 border border-gray-700 rounded-full px-1 bg-black">
            <button
                ...
                className={`px-3 py-2 rounded-full text-xs cursor-pointer font-medium ${yearly ? "bg-gray-700 text-purple-400" : "text-gray-300"
                    }`}
            >
            ...
            <button
                onClick={() => !yearly || toggle()}
                className={`px-4 py-2 rounded-full text-xs cursor-pointer font-medium ${!yearly ? "bg-gray-700 text-purple-400" : "text-gray-300"
                    }`}
            >
                Monthly
            </button>
